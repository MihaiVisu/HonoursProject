...
\end{tabular}
\caption{This table shows the tanking of the importance of each attribute in the classification of modes of transport problem. The rankings have been obtained by fitting a random forest classifier on the training dataset.}
